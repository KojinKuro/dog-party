...
/* harmony import */ var _css_loader_dist_cjs_js_sass_loader_dist_cjs_js_normalize_css__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(8);
...
h2 {
  ...
  font-weight: 500;
  font-style: normal;
}`, "",{"version":3,"sources":["webpack://./src/css/index.scss","webpack://./src/css/_fonts.scss","webpack://./src/css/_variables.scss","webpack://./src/css/_mixins.scss"],"names":[],"mappings":"AAIA;ECDE,kCAAA;EACA,yBAAA;EACA,gBAAA;EACA,kBAAA;EDCA,iBAAA;EACA,WAAA;AAAF;;AAGA;EAEE,yBEZuB;EFcvB,aAAA;EACA,8BAAA;EACA,mBAAA;EAEA,kBAAA;AAHF;AAKE;EACE,WAAA;AAHJ;AAME;EACE,aAAA;EACA,SAAA;AAJJ;AAMI;EACE,kBErBY;EFsBZ,YEzBW;EF0BX,qBAAA;AAJN;;AASA;EACE,aAAA;EACA,sBAAA;EACA,mBAAA;EAEA,SAAA;EACA,aAAA;EAEA,gEAAA;AARF;AAUE;EG1CA,YH2CuB;EG1CvB,aH0CuB;EGxCvB,oBAAA;EACA,iBAAA;EARA,yBAAA;AH2CF;;AASA;EACE,uBEnDiB;AF6CnB;;AASA;EACE,aAAA;EACA,mBAAA;EACA,6BAAA;EACA,eAAA;EAEA,kBAAA;AAPF;AASE;EACE,aAAA;EACA,sBAAA;EACA,mBAAA;EAEA,gBE3Da;EF4Db,kBAAA;EAGA,SADW;EAEX,cAAA;EAEA,iBErEgB;AF0DpB;AAcE;EG3EA,YH4EuB;EG3EvB,aH2EuB;EGzEvB,oBAAA;EACA,iBAAA;EARA,yBAAA;AHwEF;;AAaA;EGrFE,yBAAA;EFEA,kCAAA;EACA,yBAAA;EACA,gBDmFkB;EClFlB,kBAAA;EDoFA,uBEvFiB;EFwFjB,cE3FkB;EF4FlB,kBEnFgB;EFoFhB,kBAAA;EACA,iBAAA;AARF;;AAWA;EC9FE,kCAAA;EACA,yBAAA;EACA,gBD6FkB;EC5FlB,kBAAA;ED6FA,kBE1FgB;EF4FhB,aAAA;EACA,sBAAA;EACA,mBAAA;EAEA,aAAA;EACA,SAAA;EAEA,yBE5GkB;EF6GlB,YEvGe;AF+FjB;AASE;EACE,YEzGa;AFkGjB;AAUE;EACE,aAAA;EACA,8BAAA;EACA,YAAA;AARJ;;AAYA;;ECtHE,kCAAA;EACA,yBAAA;EACA,gBDsHkB;ECrHlB,kBAAA;AD+GF","sourcesContent":["@import \"fonts\";\n@import \"variables\";\n@import \"mixins\";\n\nbody {\n  @include raleyway(400);\n\n  min-height: 100vh;\n  width: 100%;\n}\n\nnav {\n  // Example of using a variable:\n  background-color: $secondary-accent-color;\n\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n\n  padding: 10px 30px;\n\n  .dog-icon {\n    width: 50px;\n  }\n\n  .links {\n    display: flex;\n    gap: 20px;\n\n    a {\n      font-size: $large-font-size;\n      color: $font-color-alt;\n      text-decoration: none;\n    }\n  }\n}\n\nheader {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n\n  gap: 15px;\n  padding: 40px;\n\n  background: url(\"../../dist/images/park.jpg\") center/cover;\n\n  img {\n    @include circle-clip(300px);\n    @include add-border(4px, $main-accent-color);\n  }\n}\n\nmain {\n  background-color: $background-color;\n}\n\n.dog-card-container {\n  display: flex;\n  flex-direction: row;\n  justify-content: space-evenly;\n  flex-wrap: wrap;\n\n  padding: 50px 20px;\n\n  .dog-card {\n    display: flex;\n    flex-direction: column;\n    align-items: center;\n\n    max-width: $dog-card-width;\n    text-align: center;\n\n    $card-gap: 10px;\n    gap: $card-gap;\n    margin: 0 calc($card-gap * 2);\n\n    font-size: $default-font-size;\n  }\n\n  img {\n    @include circle-clip(250px);\n    @include add-border(3px, $main-accent-color);\n  }\n}\n\nbutton {\n  @include add-border(5px, $main-accent-color);\n  @include raleyway(500);\n\n  background-color: $background-color;\n  color: $main-accent-color;\n  font-size: $large-font-size;\n  width: fit-content;\n  padding: 5px 12px;\n}\n\nfooter {\n  @include raleyway(600);\n  font-size: $large-font-size;\n\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n\n  padding: 15px;\n  gap: 30px;\n\n  background-color: $main-accent-color;\n  color: $font-color-alt;\n  a {\n    color: $font-color-alt;\n  }\n\n  .socials {\n    display: flex;\n    justify-content: space-between;\n    width: 400px;\n  }\n}\n\nh1,\nh2 {\n  @include raleyway(500);\n}\n","@import url(\"https://fonts.googleapis.com/css2?family=Raleway:ital,wght@0,100..900;1,100..900&display=swap\");\n\n@mixin raleyway($weight) {\n  font-family: \"Raleway\", sans-serif;\n  font-optical-sizing: auto;\n  font-weight: $weight;\n  font-style: normal;\n}\n\n@mixin raleyway-italic($weight) {\n  @include raleyway($weight);\n  font-style: italic;\n}\n","$main-accent-color: #3f8da8;\n$secondary-accent-color: #92e0e5;\n\n$background-color: white;\n\n$font-color: black;\n$font-color-alt: white;\n\n$default-font-size: 1.1rem;\n$large-font-size: 1.25rem;\n\n$dog-card-width: 350px;\n","@mixin add-border($width, $color) {\n  border: $width solid $color;\n}\n\n@mixin circle-clip($diameter) {\n  width: $diameter;\n  height: $diameter;\n\n  border-radius: calc($diameter/2);\n  object-fit: cover;\n}\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
/* harmony import */ var _css_index_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(11);
